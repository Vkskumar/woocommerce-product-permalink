...
# main config
PLUGINSLUG="woocommerce-product-permalinks"
CURRENTDIR=`pwd`
MAINFILE="woocommerce-product-permalinks.php" # this should be the name of your main php file in the wordpress plugin
